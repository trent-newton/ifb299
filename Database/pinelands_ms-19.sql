...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2016 at 02:48 AM
...
(7, NULL, '45', 'Main', 'street', 'Caboolture', '4510', 'QLD'),
(8, NULL, '1', 'Kickarse', 'street', 'MyTown', '4000', 'QLD');
...
CREATE TABLE `applications` (
  ...
  `instrument` varchar(400) DEFAULT NULL,
...
INSERT INTO `applications` (`idapplications`, `userID`, `language`, `availability`, `instrument`, `fileName`) VALUES
(17, 5, 'English', 20, '1', '5.sql'),
(18, 7, 'English Japanese Spanish ', 15, 'Cello Drums Flute ', '7.pdf'),
(23, 8, 'English,Japanese,Spanish,German,Malay,Mandarin,', 15, 'Harp,', '8.pdf');
...
(1, 4, 'Monday', '09:00:00', '18:00:00'),
(2, 4, 'Tuesday', '09:00:00', '17:00:00'),
(3, 4, 'Wednesday', '09:00:00', '11:00:00'),
(4, 4, 'Wednesday', '12:00:00', '19:00:00'),
(5, 4, 'Thursday', '08:00:00', '16:00:00'),
(6, 4, 'Friday', '09:00:00', '14:00:00'),
(7, 5, 'Tuesday', '09:00:00', '16:00:00'),
(8, 5, 'Thursday', '07:00:00', '15:00:00'),
(9, 6, 'Monday', '08:00:00', '17:00:00'),
(10, 6, 'Tuesday', '08:00:00', '17:00:00'),
(11, 6, 'Thursday', '08:00:00', '18:00:00'),
(12, 6, 'Friday', '08:00:00', '15:00:00');
...
(26, 3, 5, '2016-09-07', '2016-12-30', '12:00:00', 'Monday', '60', 1),
(27, 3, 5, '2016-09-07', '2016-12-30', '12:00:00', 'Monday', '60', 1),
(28, 3, 5, '2016-09-07', '2016-12-30', '12:00:00', 'Monday', '60', 1),
(29, 3, 5, '2016-07-04', '2016-09-05', '11:00:00', 'Tuesday', '60', 1),
(30, 3, 5, '2016-09-07', '2016-12-30', '11:00:00', 'Tuesday', '60', 1);
...
(12, 25, 1, '2016-09-07', '2016-09-07', NULL, b'0');
...
INSERT INTO `leaverequests` (`leaveID`, `userID`, `startDate`, `endDate`, `status`, `requestDate`, `reason`) VALUES
(1, 5, '2016-08-01', '2016-08-01', 'Denied', '2016-10-11', 'dev'),
(2, 5, '2016-08-01', '2016-08-03', 'Pending', '2016-10-11', 'Because I am going to be sick those days'),
(3, 5, '2016-08-03', '2016-08-03', 'Approved', '2016-10-11', 'I have a job interview at another place'),
(4, 5, '2016-08-01', '2016-08-01', 'Denied', '2016-10-11', 'pdf'),
(5, 5, '2016-08-04', '2016-08-03', 'Denied', '2016-10-11', 'sdfdsfs'),
(6, 5, '2016-08-04', '2016-08-03', 'Denied', '2016-10-11', 'sdfdsfs'),
(7, 5, '2016-10-17', '2016-10-17', 'Pending', '2016-10-17', 'asdas');
...
(1, 4, 2, 0, 'Great lesson', 5, '2016-09-12', 'Public'),
...
(2, 'Peter', 'Schwartz', '1980-09-06', 'Male', NULL, 'pschwartz914@gmail.com', '37d28940621c7ce9d9734d03ffee958c0cd9dc299ee5ad075795720e8d04b4e2', '293f477c9270fba5bfda76c88cd9521e', 'Owner', NULL, NULL, NULL),
(3, 'Peter', 'Schwartz', '1980-09-06', 'Male', '', 'peter@email.com', '12afc8bbe93b0da396a7b2c75c53ae3170ad1feabddd76fc71a6f28e230dd7c2', 'ca69d2aa456bfeaee62fe2d0dbf54761', 'Admin', NULL, 'test', ''),
...
(7, 'John', 'Smith', '2010-09-09', 'Male', NULL, 'John@email.com', '1249e5d35c8ad742a05aa431d024b5050444ed9cf33c234db5c0dfbd53749530', '5080ea18eb416f8975c6e727acc25bf9', 'Student', NULL, 'John', 'John@senior.com'),
(8, 'John', 'Anderson', '1972-09-01', 'Male', NULL, 'j.anderson@email.com', 'fc9bde54ecf2da31f38d532ed3f3dda1e1f13f280304bb728bd15c5549d66587', '98850b2255a6e5ddc0af4462521d31d0', 'Guest', NULL, NULL, NULL),
(9, 'Rambo', 'Stalone', '1965-01-01', 'Male', NULL, 'R.Stalone@email.com', 'f61a7a6442696b3c76c1321142aef3a0719f50acb9de132f122a04493f3afb01', 'dbf4962c22f5757aabb41cc1d6e7a4fc', 'Student', NULL, NULL, NULL);
...
ALTER TABLE `applications`
  ADD PRIMARY KEY (`idapplications`),
...
ALTER TABLE `leaverequests`
  ...
  ADD KEY `FK_userID_idx` (`userID`),
  ADD KEY `FK_userID_leave` (`userID`);
...
--
ALTER TABLE `applications`
  MODIFY `idapplications` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `availability`
--
ALTER TABLE `availability`
  MODIFY `availabilityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `forgotpassword`
  MODIFY `forgotID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `instrumenthire`
--
ALTER TABLE `instrumenthire`
  MODIFY `instrumentHireID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `schoolinstruments`
  MODIFY `schoolInstrumentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `instrumenthire`
  ADD CONSTRAINT `fk_contractID-Hire` FOREIGN KEY (`contractID`) REFERENCES `contracts` (`contractID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `leaverequests`
  ADD CONSTRAINT `FK_userID_leave` FOREIGN KEY (`userID`) REFERENCES `users` (`UserID`) ON UPDATE CASCADE;
