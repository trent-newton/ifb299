...
<div class="content">
    <fieldset class="accountDetails">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <br />
            <input type="text" name="pName" id="txtPName" placeholder="Mary Appleseed" value="<?php if (isset($_POST['pName'])) echo $_POST['pName'] ?>"><?php echo "<span class='required'>  ".$errorPName."</span>" ?>
            <br />
