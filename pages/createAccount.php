...
<div class="content">
    <form class="createAccount" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        <h1>Student</h1>
        ...
        <input type="text" name="unitNum" id="txtUnitNum" size="2" maxlength="4" placeholder="4" value="<?php if (isset($_POST['unitNum'])) echo $_POST['unitNum'] ?>">
        <label id="lblStreetNum" for="txtStreetNum">Street #<span class="required">*</span>: </label>
        <input type="text" name="streetNum" id="txtStreetNum" size="3" maxlength="4" placeholder="42" value="<?php if (isset($_POST['streetNum'])) echo $_POST['streetNum'] ?>" required>
        <br />
        ...
        <br />
        <label id="lblSEmail" for="txtSEmail">Email Address<span class="required">*</span>: </label>
        <br />
        ...
        <br />
        <input type="text" name="pName" id="txtPNme" placeholder="Mary Appleseed" value="<?php if (isset($_POST['pName'])) echo $_POST['pName'] ?>"><?php echo "<span class='required'>  ".$errorPName."</span>" ?>
        <br />
        <label id="lblPEmail" for="txtPEmail">Email Address<span class="required">*</span>: </label>
        <br />
        <input type="email" name="pEmail" id="txtPEmail" placeholder="parent@address.com" value="<?php if (isset($_POST['pEmail'])) echo $_POST['pEmail'] ?>"><?php echo "<span class='required'>  ".$errorPEmail."</span>" ?>
        <br />
