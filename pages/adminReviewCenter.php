...
<div class="adminCenter">
    ...
    <div>
        <div class="temp"><a href="../pages/adminReviewPending.php"><img class="AdminCenterImage" src="../images/admin-icons/reviews/pending.png"></a>
           <br><button class="AdminCenterButton reviewButton"><a href="adminReviewPending.php" class="button">Pending</a></button>
        </div>

        <div class="temp"><a href="../pages/adminReviewPublic.php"><img class="AdminCenterImage" src="../images/admin-icons/reviews/public.png"></a>
           <br><button class="AdminCenterButton reviewButton"><a href="adminReviewPublic.php" class="button">Public</a></button>
        </div>

        <div class="temp"><a href="../pages/adminReviewPrivate.php"><img class="AdminCenterImage" src="../images/admin-icons/reviews/private.png"></a>
           <br><button class="AdminCenterButton reviewButton"><a href="adminReviewPrivate.php" class="button">Private</a></button>
        </div>

        <div class="temp"><a href="../pages/adminReviewInvalid.php"><img class="AdminCenterImage" src="../images/admin-icons/reviews/invalid.png"></a>
