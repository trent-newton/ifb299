  ...
  function init_map()
  {
    ...
    <div class="content contactUs">
        ...
        <form action="../../inc/contact_form_processing.php" style="display:inline-block;padding-right:40px;" method="post">
          ...
          <div class="controls">
            <input class="form-control" name="first_name" id="first_name" placeholder="John" required>
          </div>

          <label class="control-label" for="last_name">Last Name <span class="required">*</span></label>
          <div class="controls">
            <input class="form-control" name="last_name" id="last_name" placeholder="Appleseed" required>
          </div>

          <div class="control-group">
            <label class="control-label" for="email">Email <span class="required">*</span></label>
            <div class="controls">
              <input class="form-control" name="email" type="email" id="email" placeholder="email@address.com" required>
            </div>
          </div>
          ...
          <button  class="form-control" type="submit" class="btn btn-large">Send</button>
