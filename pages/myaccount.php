    ...
    <div class="content">
        ...
        <fieldset class="accountDetails">
            <form method="post" action="../inc/updateaccount.php">
                ...
                <input type="text" name="streetNumber" value="<?php echo $row['streetNumber']?>" size="2" required /><br />
                <label>Street</label><br />
                <input type="text" name="streetName" value="<?php echo $row['streetName']?>" required /><br />
                ...
                <input type="text" name="suburb" value="<?php echo $row['suburb']?>" required /><br />
                <label>PostCode</label><br />
                <input type="text" name="postcode" value="<?php echo $row['postCode']?>" required /><br />
